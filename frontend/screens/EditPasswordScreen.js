  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView keyboardShouldPersistTaps="handled">
        ...
        <TouchableHighlight style={[styles.editPasswordButton, editPasswordButtonDisabled && styles.editPasswordButtonDisabled ]} disabled={editPasswordButtonDisabled} underlayColor={isDarkMode ? '#999999' : '#999999'} onPress={handleUpdatePassword} >
