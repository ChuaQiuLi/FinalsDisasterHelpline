      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.inputContainer}>
          ...
          <Text style={styles.description}>
            Password must be at least 8 characters long, and must contain 1 of upper and lower case letters, numbers, and special characters (e.g., @, #, $, %).
          </Text>
        </View>
        ...
        <TouchableHighlight
          style={[
            ...
            (isRegisterDisabled || loading) && styles.registerButtonDisabled
          ]}
